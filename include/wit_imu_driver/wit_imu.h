...
public:
    ...
    bool popImuData(sensor_msgs::msg::Imu::SharedPtr const p_msg)
    {
        if (imu_buf_.empty())
        {
            return false;
    ...
    bool popTempData(sensor_msgs::msg::Temperature::SharedPtr const p_msg)
    {
        if (temp_buf_.empty())
        {
            return false;
    ...
    bool popMagData(sensor_msgs::msg::MagneticField::SharedPtr const p_msg)
    {
        if (mag_buf_.empty())
        {
            return false;
